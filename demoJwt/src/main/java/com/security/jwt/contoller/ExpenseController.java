package com.security.jwt.contoller;
...
public class ExpenseController {
    ...
    @PostMapping()
    public ResponseEntity<?>  save(@RequestParam String description , @RequestParam Double amount , @RequestParam String category , @RequestParam MultipartFile file) {
    ...
    public ResponseEntity<?>  update(@PathVariable Long userid , @PathVariable Long expenseId ,
        ...
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        try{
            Expense response = expenseService.updateExpense(userid ,expenseId,description,amount,category,file);
